...
class BallVolumeMeasurement:
    ...
    def calibrate(self, pixel_diameter, real_diameter):
        ...
        # Tampilkan notifikasi "Kalibrasi Selesai" di LCD
        self.lcd.text("Kalibrasi Selesai", 1)
        self.lcd.text(f"Rasio: {self.calibration_ratio:.2f}", 2)
    ...
    def calculate_volume(self, pixel_diameter):
        ...
        3. Hitung volume menggunakan rumus bola: V = (4/3)?r³
        ...
        while True:
            ...
            if circle is not None:
                ...
                if not calibration_done:
                    ...
                    # Tampilkan notifikasi "Kalibrasi" di LCD
                    self.lcd.text("Tekan 'c' untuk", 1)
                    self.lcd.text("kalibrasi", 2)
                else:
